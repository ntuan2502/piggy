...
const en = {
    ...
    transaction: {
        ...
        autoCategorize: "Auto Categorize",
        categorizeFailed: "Auto categorize failed",
        categorizeSuccess: "Successfully categorized {{successCount}}/{{count}} transactions",
        categorizingStarted: "Starting categorization for {{count}} transactions...",
        categorizingBatch: "Processing batch {{current}}/{{total}} (Waiting for API limit)...",
    ...
    wallet: {
        ...
        creditCommon: "Credit Info",
        creditLimit: "Total Limit",
        creditRemaining: "Remaining Limit",
