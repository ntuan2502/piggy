...
const vi = {
    ...
    report: {
        availableBalance: "Tổng số dư khả dụng",
        ...
        topExpense: "Top Chi tiêu",
        topIncome: "Top Thu nhập",
        trend: "Xu hướng",
    ...
    transaction: {
        ...
        categorizeSuccess: "Đã phân loại thành công {{successCount}}/{{count}} giao dịch",
        categorizingStarted: "Đang bắt đầu phân loại {{count}} giao dịch...",
        categorizingBatch: "Đang xử lý gói {{current}}/{{total}} (Đang chờ giới hạn API)...",
    ...
    wallet: {
        ...
        creditCommon: "Thông tin tín dụng",
        creditLimit: "Tổng hạn mức",
        creditRemaining: "Hạn mức còn lại",
        creditTotal: "Tổng dư nợ",
        ...
        recalculate: "Tính lại số dư",
        recalculateFailed: "Tính lại số dư thất bại",
        recalculateSuccess: "Đã tính lại số dư thành công",
        select: "Chọn ví",
